...
let arrNom = [];
for(let i=0; i<POKEMON.pokemon.length; i++){
  arrNom.push(POKEMON.pokemon[i].name);
}


function ordenar(arr){
if(document.getElementById("myBtn").value === "A-Z"){
  arr.sort();
}
else if(document.getElementById("myBtna").value === "Z-A"){
  arr.sort();
  arr.reverse();
}
return arr;
...
document.getElementById("demo").innerHTML=arrNom
/*
